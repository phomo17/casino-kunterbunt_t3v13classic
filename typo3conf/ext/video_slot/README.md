...
| Abhängigkeit | `casino_startpage` >= 0.4.0 (Design-Tokens, darunter die beiden neuen Fruchtfarben) |
...
Version 0.4.0 (alpha). Aus Teil B sind die Phasen 5, 6 und 7 eingearbeitet:
